...
export const sensitiveSourcePaths = [
  ...
  "apps/desktop/src/workspaceRecoveryOperation.ts",
  "apps/desktop/src/workspaceReplacementOperation.ts",
  ...
  "apps/desktop/src/contentMarker.ts",
  "apps/desktop/src/nodeTemplates.ts",
  "apps/desktop/src/canvasNavigation.ts",
  "apps/desktop/src/NodeTemplatesDialog.tsx",
  ...
  "apps/desktop/src/secretContent.tsx",
